         ...
         <div class="menu_section">
                            <h3>Management</h3>
                            <ul class="nav side-menu">
                                <li><a href="{{route('dashboard')}}"><i class="fa fa-user"></i> Management Admin <!-- <span class="fa fa-chevron-down"></span> --></a>
                                    <ul class="nav child_menu" style="display: none">
                   ...
                   <div class="sidebar-footer hidden-small">
                        ...
                        <a data-toggle="tooltip" href ="{{route('logout')}}" data-placement="top" title="Logout">
