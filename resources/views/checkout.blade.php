...
<!--     <div class="modal-footer">
  ...
  <div class="container">
    ...
    <!-- Breadcrumbs Structure-->
          ...
          <tr>
            ...
            <div class="input-field col s6">
              <select>
                ...
                <option value="3">Pagi dan Sore</option>
              </select>
            </div>
            </td>
          </tr>
      ...
      <h5 class="red-text lighten-1">Review Pemesanan</h5>
      <table class="striped">
        <thead>
          <tr>
              <th data-field="name">Nama</th>
              <th data-field="">Kategori</th>
              <th data-field="">Jumlah</th>
              <th data-field="price">Harga</th>
              <th data-field="">Catatan</th>
      ...
      <br>
      <a class="waves-effect waves-light btn right"><i class="fa fa-opencart right"></i>Checkout</a>
      <br><br>
