...
class PageController extends Controller
{
   ...
   public function adminEmailChecker(String $request)
    ...
    public function deleteUser($id)
    {
        $result= Person::where('username','=',$id)->first();
        $result->delete();
        return redirect()->route('dashboard')->withErrors('A user has just been deleted!');
    }
    ...
    public function registerUser(Request $request)
    {
        ...
        if(!is_null($unamequery)||!is_null($emailquery))
        {   
            return redirect()->route('createuser')->withErrors('A user with that username or email has already exists!');             
        }
        $newuser->save();
    ...
    public function saveKategori(Request $request)
    {
        ...
        if($keyword!=$user_username)
        {
            ...
            if(!is_null($unamequery))
            {   
                return redirect()->route('editkategori',array('nama'=>$keyword))->withErrors('A category with that name has already exists!');             
            }
        ...
        return redirect()->route('dashboard')->withErrors('A category has just been updated!');
    }
    ...
    public function saveProduct(Request $request)
    {
        ...
        if($keyword!=$user_username)
        {
            ...
            if(!is_null($unamequery))
            {   
                 return redirect()->route('editproduct',array('nama'=>$keyword))->withErrors('A product with that name has already exists!');             
            }
        ...
        return redirect()->route('dashboardproduct')->withErrors('A product has just been updated!');
    }
